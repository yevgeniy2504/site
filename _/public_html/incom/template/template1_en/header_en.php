...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="yandex-verification" content="8fe011c7e977cbfb" />
  <?php include_once($_SERVER['DOCUMENT_ROOT']."/incom/seo/seo_en.php"); ?>
...
<!-- End Google Tag Manager -->
  ...
  <link href="/incom/template/template1_en/css/style2.css?v=4.2" rel="stylesheet" type="text/css" />
  <link href="/incom/template/template1_en/css/superfish2.css?v=1" rel="stylesheet" type="text/css" />
  <link rel="stylesheet" type="text/css" href="/incom/template/template1_en/js/fancybox/jquery.fancybox-1.3.4.css" media="screen" />
  ...
  <script type="text/javascript" src="/incom/template/template1_en/js/superfish.js"></script>
  <script type="text/javascript" src="/incom/template/template1_en/js/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
...

{
	...
	<script type="text/javascript" src="/incom/template/template1_en/js/script.js"></script>
...
/*if ($_SERVER['REQUEST_URI'] == '/'.$lang.'/')
{
  */?><!--
  <script>
   ...
   function go_to(){
     $.cookie('inn', '1', { expires: 1, path: '/' });
     location.href='/en/page/goryachie-predlozheniya';
   }
 </script>
<?/*
 die("SELECT * FROM i_block_elements WHERE rec_act1=1 AND id_section=130 AND version='".$lang."' LIMIT 1");
		...
		<div id="pr"  style="  width:448px; background:#fff; height:344px; position:fixed; top:50%; left:50%;  margin-left:-225px; margin-top:-177px; display:none; z-index:2147483647; border-radius:15px; -moz-border-radius:15px; -webkit-border-radius:15px; ">
			...
			echo '<a></a>';
					while($r=mysql_fetch_array($s))
					{
						...
						<img src="/upload/images/'.$r["rec_img1"].'" style="width:91%;" alt="" />
						</a>
						';
						 echo '
						 <a style="width:auto; height:auto;" '.(trim($r["banner_link1"]) !='' ? 'href="'.$r["banner_link1"].'"' : '').'>
...
<!-- End Facebook Pixel Code -->
    ...
    <script type='text/javascript'>
        ...
        (function(w) {
            var q = [
                ['setContext', 'TL-INT-uyut-almati.new-form', 'en-gb'],
  ...
  <div class="top">
   ...
   <div class="main">
    ...
    <div class="head_address" style="margin-top: -5px;">
      ...
      <span class="head_address_text" style="vertical-align: top;"><a href="/en/contacts95/">127/1 Gogol street crossed by Seifullin Street, Almaty</a></span>

      <span class="booking_phone">Booking: <a href="tel:+77272795111"> +7 (727) 279-51-11</a><br>
        email: <a href="mailto:reservation@hotel-uyut.kz">reservation@hotel-uyut.kz</a></span>

    </div>

    <a class="logo" href="/<?=$lang?>/"  style="font-size:18px;    font-family: 'Open Sans Condensed';
    text-align: right;
    color: #ea9103;
    margin-left:-20px;
    line-height: 140px;
" > HOTEL UYUT</a>
    <!-- <a class="logo" href="/<?=$lang?>/" style="display:flex;" > <img src="<?=$SERVER['DOCUMENT_ROOT']?>/incom/template/template1_en/images/logo.png" alt="logo"> HOTEL UYUT</a> -->
...
<div id="langs">
 ...
 <table width="100%" cellpadding="0" cellspacing="0">
   ...
   <tr>
     ...
     <td><a class="lang active"><img src="/incom/template/template1_en/images/en.png" /></a></td>

     <td><a href="/" class="lang"><img src="/incom/template/template1_en/images/ru.png" /></a></td>

     <td><a href="/kz/" class="lang"><img src="/incom/template/template1_en/images/kz.png" /></a></td>
...
<div id="wraper"<? if ($_SERVER['REQUEST_URI'] != '/'.$lang.'/') { ?> class="margT40"<? }?>>
  ...
  <div class="index">
   ...
   <div id="left">
    <!-- <style>
      ...
      <div class="elka2">
         <img src="/incom/template/template1_en/images/elka2.png" alt="" />
      </div> -->

    <?

    $s=mysql_query("select * from i_block_elements where id=94");

    $r=mysql_fetch_array($s);

	$seo_caption_en = stripslashes($r["page_name"]);
    ...
    if ($s && mysql_num_rows($s)>0){
      ...
      while ($r = mysql_fetch_array($s)) {
        ...
        <div class="room_cat" style="<?=($i==2?'margin-right:0px;':'')?>">
          <div class="name"><a href="/en/catalog/<?=$r["translit_name"]?>/" style="font-size: 18px;"><?=$r["catalog_name"]?></a></div>
          <div class="image"><a class="linknoindex1" data-href="/en/catalog/<?=$r["translit_name"]?>/"><img src="/upload/images/big/<?=$r["catalog_img"]?>" alt="" /></a></div>
	  ...
	  echo '<h1 class="title1">'.$seo_caption_en.'</h1>';
 echo stripslashes($text[0]);
  ...
  <div id="right">
    ...
    padding: 0 0 30px;
    font-weight: 300;">Actions <a href="/en/actions/" style="text-decoration:underline; font-size: 14px; margin-top: 5px; float:right;">View All</a></span>
    <?
    ...
    if ($s && mysql_num_rows($s)>0){
      while ($r = mysql_fetch_array($s)) {
        ...
        <div class="room_cat" style="width: 100%; text-align: left;">
          <div class="name"><a href="/en/actions/<?=$r["translit_name"]?>/" data-link="/en/actions/<?=$r["translit_name"]?>/" class="linknoindex"><?=$r["cat_name"]?></a></div>
          <? if ($r["cat_img"]!=''){ ?>
          <div class="image"><a href="/en/actions/<?=$r["translit_name"]?>/" data-link="/en/actions/<?=$r["translit_name"]?>/" class="linknoindex"><img src="/upload/images/small/<?=$r["cat_img"]?>" alt="" /></a></div>
          <? } ?>
    ...
    <img style="margin-bottom: 23px;" width="240" src="/upload/images/2018_COE_Logos_Green-bkg_translations_en-US-UK.png" alt="" />
    <img width="235" src="/upload/images/uyut_new2.png" alt="" />


    <span style="font-size: 26px; margin-top: 30px; display: block;
    text-transform: uppercase;
    padding: 0 0 30px; line-height: 26px;
    font-weight: 300;"><a href="/en/guest/" style="text-decoration:underline">Customer reviews</a></span>
...
<? } else { ?>
<?
	if($_SERVER['REQUEST_URI']=='/en/sertifikaty.php'){
						$h1title = 'Certificates';
					}
	?>
<?=$incom->breadcrumb($lang, $h1title)?>
<?
if (substr($_SERVER['REQUEST_URI'], 0, 13) === '/en/guest/?p=') {
$lastSymbol = substr($_SERVER['REQUEST_URI'], -1);
$page = ' - PAGE '.$lastSymbol.'';
}
?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left"><h1 class="title">
      <?=@$h1title?>
      <?=@$page?>
    </h1></td>
 </tr>
