...
<!-- End Google Tag Manager (noscript) -->
  <div id="footer">
   <div class="main">
     ...
     <div class="copy">
       <? if($_SERVER['REQUEST_URI']=='/'.$lang.'/'){?>Hotel «UYUT»<br />
       Official site<br />
       <?=date('Y', time())?><? }else{?><a href="https://www.hotel-uyut.kz/en/">Hotel «UYUT»<br />
       Official site</a><br />
       2017<? }?>
     </div>
     <div class="phones">
      7 (727)
      <strong>279 51 11</strong>
      <strong>279 55 11</strong><br/>
      mob. <strong>+7-777-218-31-32</strong>
...
<? /* ?> 
                       ...
                       (function (d, w, c) {
                          ...
                          (w[c] = w[c] || []).push(function() {
                             ...
                             try {
                                ...
                                w.yaCounter24724379 = new Ya.Metrika({id:24724379,
                 ...
                 <noscript><div><img src="https://mc.yandex.ru/watch/24724379" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
                 ...
                 <script type="text/javascript" >
                  (function (d, w, c) {
                    (w[c] = w[c] || []).push(function() {
                      try {
                        w.yaCounter42688734 = new Ya.Metrika({
                          id:42688734,
                          clickmap:true,
                          trackLinks:true,
                          accurateTrackBounce:true,
                ...
                <noscript><div><img src="https://mc.yandex.ru/watch/42688734?ut=noindex" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
                <!-- /Yandex.Metrika counter -->
             
                    <? /* ?>
                    <a href="https://play.google.com/store/apps/details?id=com.app_hoteluyut.layout" title="Android App" target="_blank"><img src="/incom/template/template1/images/android_app.png" alt="Android app"></a>
                    <? */ ?>
                  </div>
                </div>	
                <div class="adress">
                 Hotel «UYUT»<br />
                 Almaty city, Gogol' st. 127/1, int.Seifullun ave.
               </div>
                <? /* if($_SERVER['PHP_SELF']=='/en/index.php'){?>
                <div class="soc_links">
                	<a href="https://instagram.com/uyut_hotel/" target="_blank"><img src="/incom/template/template1_en/images/insta.png" /></a>
...
<!--<script type='text/javascript'>
(function(){ var widget_id = 'hypTDiXLNV';
...
<div class="topinfo rel" id="cookiesBar" style="<?=@$_COOKIE["ckk"]==1?'display: none;':''?>">
  ...
  <p class="normal cfff">
    We use <a href="/en/hotel-policies661/">cookies</a> to manage, improve and personalize the website settings. Continuing to browse the site, you agree to the use of cookies
  </p>
</div>
