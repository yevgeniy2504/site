...
?></td>
      ...
      <td height="29" align="center" class="panel_back" style="border: 1px solid #c4c5a6;"><table width="98%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="20%" align="center" onmouseover="this.className='cell_border_small';" onmouseout="this.className='small_text';"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="16%" align="center"><a href="add_elements.php<?=$ob->gets_go($_GET,"module","block_elements")?>"><img src="/incom/modules/theme/default/images/blank.gif" alt="добавить элемент" width="16" height="21" border="0" /></a></td>
                  <td width="84%" align="center" class="small_text"><a href="add_elements.php<?=$ob->gets_go($_GET,"module","block_elements")?>" class="small_text">Добавить элемент</a></td>
                </tr>
            </table></td>
            ...
            <td width="15%" align="center" onmouseover="this.className='cell_border_small';" onmouseout="this.className='small_text';"><table width="90%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="37%" align="center"><a href="import.php<?=$ob->gets_go($_GET,"","")?>"><img src="/incom/modules/theme/default/images/excel.gif" alt="импорт из excel" width="22" height="22" border="0" /></a></td>
                <td width="63%" align="center" class="small_text"><a href="import.php<?=$ob->gets_go($_GET,"","")?>" class="small_text">Import</a></td>
              </tr>
            </table></td>
            <td width="17%">&nbsp;</td>
   ...
   echo '<tr>
	...
	<tr>
	  ...
	  /*$hide_ar=array();
	  $hide_ar2=array();
	  $field_name=$ob->select("i_option",array("category"=>"block","select_fields"=>1),"id_sort");
	  ...
	  for($i=0;$i<=4;$i++)
	  {
	  	if($i==0)
	  	{
	  	$hide=$ob->select("i_block",array("id"=>$_GET['id_section']),"");
	  	$hide_res=mysql_fetch_array($hide);
	  	array_push($hide_ar,$hide_res[''.$hide_field_name.'']);
		array_push($hide_ar2,'index.php?module=block');
		}else
		{
		$hide=$ob->select("i_block",array("id"=>$hide_res['id_section']),"");
	  	$hide_res=mysql_fetch_array($hide);
		array_push($hide_ar,$hide_res[''.$hide_field_name.'']);
		array_push($hide_ar2,'index.php?id_section='.$hide_res['id'].'&module=block');
		}
	  }
...
';
	  ...
	  {
	  $section=$ob->select("i_block",array("id_section"=>$res['id']),"");
	  $elements=$ob->select("i_block_elements",array("id_section"=>$res['id']),"");
...
//-->
		...
		$field2=$ob->search_option("block_elements",$_GET['sub_module'],@$_GET['id_section'],array("select_fields"=>1));
    ...
    <tr>
      <td height="30" align="right" bgcolor="#ecebcf" class="small_text" style="border: 1px solid #c4c5a6;border-top: 0px solid ;">Всего:     <?=mysql_num_rows($select_all)?>
        &nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>
  </table>
</form>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#ecebcf">
	  ...
	  $str.='<tr >';
		$field=$ob->search_option("block_elements",$_GET['sub_module'],@$_GET['id_section'],array("select_fields"=>1));
