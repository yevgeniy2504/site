...
if ($r["page_act"]==1)
{
  if ($_SESSION["version"]=='ru'){
    //mysql_query("update i_block_elements set link_menu='/".$translit."/' where link_menu='/".$r["translit_name"]."/'");
    //mysql_query("update i_block set link_menu='/".$translit."/' where link_menu='/".$r["translit_name"]."/'");
  }else{
    //mysql_query("update i_block_elements set link_menu='/".$_SESSION["version"]."/".$translit."' where link_menu='/".$_SESSION["version"]."/page/".$r["translit_name"]."'");
