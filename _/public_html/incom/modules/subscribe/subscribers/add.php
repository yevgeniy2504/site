...
$i=1;
	...
	//echo "INSERT INTO i_".$ob->pr($_GET['module'])." (id_section,version,".$field_name.") VALUES ('".@$_GET['id_section']."','".$ver."'".@$field.")";
	$i=mysql_query("INSERT INTO i_".$ob->pr($_GET['module'])." (id_section,version,".$field_name.") VALUES ('".@$_GET['id_section']."','".$ver."'".@$field.")");
