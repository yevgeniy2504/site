...
if(@$_POST['hidden'])
{
  mysql_query("INSERT INTO i_subscribes(`version`,`act`, `date`, `mail_from`, `name`, `theme`, `message`, `files`) VALUES('".$_SESSION['version']."', '".(@$_POST['act'] ? 1 : 0)."', '".date("Y.m.d")."', '".$_POST['mail_from']."', '".$_POST['name']."', '".$_POST['theme']."', '".$_POST['full_text']."', '".$_POST['upl_files']."')");
...
<form action="" method="post" enctype="multipart/form-data" name="form" id="form">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="35" class="title_text">Добавление рассылки</td>
    </tr>
    <tr>
          ...
          <tr>
            <td align="center"><table border="0" cellspacing="0" cellpadding="4">
                <tr>
                  ...
                  <td width="59%" align="left"><input name="act" type="checkbox" id="act" value="1" /></td>
                </tr>
                <tr>
                  <td align="right" class="small_text">Отсылать с e-mail:</td>
                  <td align="left"><input name="mail_from" type="text" id="mail_from" value="<?=("Administration@".$_SERVER['HTTP_HOST'])?>" size="35" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left"><input name="theme" type="text" id="theme" size="35" /></td>
                </tr>
                <tr>
                                    ...
                                    var check = 0;
                                                                        for(var i in uploaded_files)
                                       {
                                         if(uploaded_files[i].file) check++; 
                                                                                 str+='<tr class="small_text" align="center"><td><a href="/upload/subscribe/'+uploaded_files[i].file+'" target="_blank">'+uploaded_files[i].file+'</a></td><td>'+(uploaded_files[i].size/1024).toFixed(2)+' KB </td><td><a href="javascript:void(0);" onClick="if(confirm(\'Вы уверены что хотите удалить этот файл?\')) deleteUploadedFile('+(i)+');"><img src="/incom/modules/theme/default/images/b_drop.png" border="0"></a></td></tr>';
                                       }
                                    str += '</tbody></table>';
