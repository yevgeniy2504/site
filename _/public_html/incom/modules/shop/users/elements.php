...
<form id="form_index" name="form_index" method="post" action="">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="35" class="title_text">Список пользователей</td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="29" align="center" class="panel_back" style="border: 1px solid #c4c5a6;"><table width="98%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="27%" align="center" onmouseover="this.className='cell_border_small';" onmouseout="this.className='small_text';"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="16%" align="center"><a href="add_elements.php<?=$ob->gets_go($_GET,"module","shop_users")?>"><img src="/incom/modules/theme/default/images/blank.gif" alt="добавить элемент" width="16" height="21" border="0" /></a></td>
                  <td width="84%" align="center" class="small_text"><a href="add_elements.php<?=$ob->gets_go($_GET,"module","shop_users")?>" class="small_text">Добавить пользователя</a></td>
                </tr>
            </table></td>
            <td width="11%" align="center" onmouseover="this.className='cell_border_small';" onmouseout="this.className='small_text';"><table width="90%" border="0" cellspacing="0" cellpadding="0">
              <tr>
            ...
            <td width="11%" align="center" onmouseover="this.className='cell_border_small';" onmouseout="this.className='small_text';">&nbsp;</td>
            <td width="17%">&nbsp;</td>
   ...
   echo '<tr>
	...
	<tr>
	  ...
	  for($i=0;$i<=4;$i++)
	  {
		...
		array_push($hide_ar2,'index.php?module=shop_group');
		}else
		{
		$hide=$ob->select("i_shop_group",array("id"=>$hide_res['id_section']),"");
	  	$hide_res=mysql_fetch_array($hide);
		array_push($hide_ar,$hide_res[''.$hide_field_name.'']);
		array_push($hide_ar2,'index.php?id_section='.$hide_res['id'].'&module=shop_group');
		}
	  }
...
//-->
		...
		$field2=$ob->select("i_option",array("select_fields"=>1,"category"=>"shop_users","category_id"=>$_GET['id_section']),"id_sort");
