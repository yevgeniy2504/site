...
////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	class Geo
    {
        ...
        function get_geobase_data()
        {
           ...
           /* if($this->charset)
                @$string = iconv('UTF-8', @$this->charset, $string);
*/
	...
	// print_r($data);
	 ...
	 $data = $geo->get_value('country', true);
     ...
     if (!defined('_SAPE_USER')){
        define('_SAPE_USER', '41571c5f0aff16025e553f841475d94e'); 
     }
     $o['charset'] = 'UTF-8';
...
<div class="sape_style"><!--noindex--><? echo $sape->return_links($n); ?><!--/noindex--></div><? }
