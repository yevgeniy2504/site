...
$select=mysql_query("select * from i_lang where id<>0 ".$where." ORDER BY ".$ord.",'puttime' DESC LIMIT ".$start.",".$number."");
$select_all=mysql_query("select * from  i_lang where id<>0 ".$where."");
?>
          ...
          <tr>
            ...
            <td width="21%" align="center" onmouseover="this.className='cell_border_small';" onmouseout="this.className='small_text';"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="84%" align="center" class="small_text"><a href="add.php" class="small_text">Добавить язык</a></td>
                </tr>
            </table></td>
...
//-->
        ...
        <td class="table_value">'.$res['name_reduction'].'&nbsp;</td>
      </tr>';
	  }
	  ?>
      </table></td>
