...
if($_POST['hidden']=='save'){$page="index.php";}else{$page="";}
	...
	$ob->update("i_lang",array("active"=>$_POST['active'],"default"=>$_POST['default'],"name"=>$_POST['name'],"name_reduction"=>$_POST['name_reduction']),$_GET['id'],$page);
}
?>
...
<?
$select=$ob->select("i_lang",array("id"=>$_GET['id']),"");
          ...
          <tr>
            <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                ...
                <tr>
                  ...
                  <td align="left"><input name="default" type="checkbox" id="default" value="1" <? if($res['default']==1){echo "checked";}?> /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left"><input name="name_reduction" type="text" id="name_reduction" value="<?=$res['name_reduction']?>" size="35" /></td>
                </tr>
