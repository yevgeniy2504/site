...
//началась выборка
$field=array("active"=>"Активность","name"=>"Имя","last_name"=>"Фамилия","email"=>"E-mail");
$where='';
...
$select=mysql_query("select * from i_user where id<>0 ".$where." ORDER BY ".$ord.",'puttime' DESC LIMIT ".$start.",".$number."");
$select_all=mysql_query("select * from  i_user where id<>0 ".$where."");
?>
          ...
          <tr>
            ...
            <td width="26%" align="center" onmouseover="this.className='cell_border_small';" onmouseout="this.className='small_text';"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="84%" align="center" class="small_text"><a href="add.php" class="small_text">Добавить пользователя</a></td>
                </tr>
            </table></td>
